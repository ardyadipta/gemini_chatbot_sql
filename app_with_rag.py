...
schema_descriptions = [
    "Table: sales_table, Column: ORDERNUMBER, Description: Unique identifier for sales",
    "Table: sales_table, Column: QUANTITYORDERED, Description: Number of products sold",
